...
description: "Polygon Labs takes the following approach in regards to smart contract security."
---
...
Polygon Labs' public reports are located here: [Security reports](reports).
