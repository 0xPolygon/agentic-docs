...
description: Polygon Labs engineering teams are trained and instructed to use
  secure coding guidelines and follow industry standards for secure development,
  such as OWASP, w
---
