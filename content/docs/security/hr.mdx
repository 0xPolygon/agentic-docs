...
description: Polygon Labs supports onboarding and offboarding service providers
  by following a process that begins with each service provider receiving a
  preconfigured lapto
---
