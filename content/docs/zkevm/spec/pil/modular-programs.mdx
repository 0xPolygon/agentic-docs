...
description: "One of the core features of _Polynomial Identity Language_ (PIL) is that it allows modular design of its programs. This document describes how PIL connects prog"
---
...
<Callout type="info" title="Remarks about the above code">
