---
title: "Index"
description: "_Polynomial Identity Language_ (PIL) is a domain-specific language (DSL) created to provide developers with a holistic framework for constructing programs throu"
---
...
Many other domain-specific languages (DSL) or toolstacks, such as [Circom](../../concepts/circom-intro-brief) or [Halo2](https://zcash.github.io/halo2/), focus on the abstraction of a particular computational model, such as an arithmetic circuit.
