...
description: "The following document describes how proofs of execution correctness are generated using pil-stark package. Once the constant and the committed polynomials are "
---

The following document describes how proofs of execution correctness are generated using pil-stark package.

Once the constant and the committed polynomials are filled (as seen in the [Filling polynomials section](filling-polynomials)), the next step is generation of a proof of correctness.
...
A _pil-stark_ DIY guide is given [here](../../concepts/mfibonacci/pil-stark-demo).
