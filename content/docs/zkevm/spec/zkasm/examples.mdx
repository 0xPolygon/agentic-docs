---
title: "Examples"
description: "## EVM ADD Let's take the EVM ADD opcode as our first starting example: Here is a detailed explanation of how the ADD opcode gets interpreted. Recall that at th"
---
