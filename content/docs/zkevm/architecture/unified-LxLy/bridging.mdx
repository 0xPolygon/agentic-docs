---
title: "Bridging"
description: "The unified bridge transfers assets and messages between networks (L1, L2) by calling bridge and claim functions on the contract whose deployment address is an "
---
