---
title: Cross-chain exchanges
description: "This covers node configuration parameters, interchange of tokens
  among chains, and the mention of an issue with CREATE2. ### Node configuration
  The node configu"
---
