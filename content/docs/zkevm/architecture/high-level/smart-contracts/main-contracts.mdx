...
description: "## Consensus contracts The following contracts manage consensus mechanisms. They deal with sequencing and verifying transaction batches across the L1 and L2 net"
---
...
<center>
<img src="/img/cdk/high-level-architecture/rollup-manager.png" alt="Polygon Solidity smart contract rollup manager" maxWidth="80%" />
</center>
...
<center>
<img src="/img/cdk/high-level-architecture/bridge.png" alt="Polygon Solidity smart contract bridge" maxWidth="80%" />
</center>
...
<center>
<img src="/img/cdk/high-level-architecture/l1-exit-root.png" alt="Polygon Solidity smart contract exit root L1" maxWidth="60%" />
</center>
...
<center>
<img src="/img/cdk/high-level-architecture/l2-exit-root.png" alt="Polygon Solidity smart contract exit root L2" maxWidth="60%" />
</center>
