---
title: PolygonZkEVMGlobalExitRootV2.sol
description: "Contract responsible for managing the exit roots across multiple
  networks. ## Functions ### ##### Parameters | Name | Type | Description | |
  :--- | :--- | :----"
---
