---
title: PolygonZkEVMGlobalExitRootBaseStorage.sol
description: "Abstract contract required to preserve the storage slots from
  previous versions. Inherits from ## Functions None. ## Variables ### Rollup
  root, contains all exi"
---
