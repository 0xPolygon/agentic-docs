---
title: PolygonTransparentProxy.sol
description: "Inherits from , a Openzeppelin v5 contract, with the following
  modifications: - Admin is a parameter in the constructor instead of being
  deployed. - Let the adm"
---
