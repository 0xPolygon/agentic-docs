...
description: "This contract is used by the contract. It inherits the and adds the logic to calculate the leaf of the exit tree. ## Functions ### Given the leaf data it return"
---
