---
title: "PolygonZkEVMBridgeV2"
description: "Bridge contract deployed on Ethereum and all Polygon rollups. Responsible for managing the token interactions with other networks. ## Functions ### Disable init"
---
