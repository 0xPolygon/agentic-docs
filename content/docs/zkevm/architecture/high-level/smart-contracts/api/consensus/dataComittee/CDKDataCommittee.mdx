---
title: CDKDataCommittee.sol
description: "## Functions ### ### Allows the admin to setup members of the
  committee. - The system requires N/M signatures where N => and M => . - The
  number of urls must be"
---
