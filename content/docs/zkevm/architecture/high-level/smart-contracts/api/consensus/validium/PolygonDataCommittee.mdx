---
title: PolygonDataCommittee.sol
description: "## Functions ### Disables initializers on the implementation,
  following best practices. ### ### Allows the admin to setup the members of the
  committee. - The sy"
---
