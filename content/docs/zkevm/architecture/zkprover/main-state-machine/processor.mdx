---
title: "Processor"
description: "As a microprocessor-type state machine, the main SM is a typical example of a _Generic state machine_. It is a state machine that behaves like an Algebraic proc"
---
