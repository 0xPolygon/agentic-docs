---
title: "Mechanism"
description: "The Storage SM is one of zkProver's secondary state machines, and thus receives instructions from the Main SM called Storage Actions. The Storage Actions basica"
---
