...
description: The Storage executor is to the Storage Assembly code a like a
  slave-worker to the master. It carries out all _Storage Actions_ in accordance
  with rules and logi
---
