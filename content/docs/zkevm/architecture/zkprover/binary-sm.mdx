---
title: "Binary Sm"
description: "The Binary state machine is one of the six secondary state machines receiving instructions from the Main SM executor. It is responsible for the execution of all"
---
...
<div className="text-center">
  <b>All Operations Checked by the Binary SM</b>
</div>
