---
title: "Proving Tools"
description: "In this document, we provide a brief outline of the proving tool called _PIL-STARK_ and the two proving techniques namely _FRI_ and _STARK_. ## PIL-STARK PIL-ST"
---

In this document, we provide a brief outline of the proving tool called _PIL-STARK_ and the two proving techniques namely _FRI_ and _STARK_.
...
The full details of the PIL-STARK process are given [here](../../../concepts/mfibonacci/pil-stark), while the following diagram summarizes entire PIL-STARK process.
