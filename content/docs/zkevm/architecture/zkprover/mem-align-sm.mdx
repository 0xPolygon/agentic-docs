---
title: Memory-align state machine
description: "The Memory-align state machine is a secondary state machine that
  includes an executor (the Memory-align SM executor) and an internal
  Memory-align PIL (program) "
---
