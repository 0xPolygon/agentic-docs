---
title: "Bits2field Sm"
description: "The Bits2Field state machine is one of the auxiliary state machines used specifically for parallelizing the implementation of KECCAK-F SM. Its source code is av"
---
