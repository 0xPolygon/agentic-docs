---
title: "Index"
description: "As an Ethereum Layer 2 scaling solution, Polygon zkEVM gathers transactions into batches after executing them. Aggregated batches are then dispatched to Ethereu"
---
...
The zkNode architecture is modular in nature. You can dig deeper into zkNode and its components [here](zknode/index).
...
- Aggregator
  ...
  See the [Effective gas price document](../architecture/effective-gas/index) for how users can estimate the gas price to sign transactions with.
...
Check out the detailed architecture of the zkProver [here](zkprover/index).
