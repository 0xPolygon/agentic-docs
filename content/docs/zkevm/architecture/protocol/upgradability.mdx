...
description: It is inevitable for the current version of the Polygon zkEVM to go
  through updates and some upgrades, as it gets tested by both the community of
  Polygon develo
---
