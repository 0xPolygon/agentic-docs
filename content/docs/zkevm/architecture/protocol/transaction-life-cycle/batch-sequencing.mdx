---
title: "Batch Sequencing"
description: "!!!info This document is a continuation in the series of articles explaining the inside Polygon zkEVM. Batches need to be sequenced and validated before they ca"
---

!!!info
    This document is a continuation in the series of articles explaining the [transaction life cycle](transaction-execution) inside Polygon zkEVM.
