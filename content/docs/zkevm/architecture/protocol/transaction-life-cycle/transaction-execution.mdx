...
description: "!!!info This document is a continuation in the series of articles explaining the inside Polygon zkEVM. The trusted sequencer reads transactions from the pool an"
---

!!!info
    This document is a continuation in the series of articles explaining the [transaction life cycle](submit-transaction) inside Polygon zkEVM.
...
!!!note
     ...
     - Additionally, the emergency mode is activated if a sequenced batch is not aggregated in 7 days. Please refer to [this guide](../malfunction-resistance/emergency-state) to understand more about the emergency state.
