...
description: "!!!info This document is a continuation in the series of articles
  explaining the inside Polygon zkEVM. The trusted sequencer reads transactions
  from the pool an"
---
