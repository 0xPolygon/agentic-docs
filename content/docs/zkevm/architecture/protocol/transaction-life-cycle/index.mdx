---
title: "Index"
description: "Users need funds on L2 to be able to send transactions to the L2 network. To do so, users need to deposit Ether to L2 through the . Bridging: - Deposit ETH. - W"
---
...
Take a look at the complete description in the [transaction life cycle](./submit-transaction)
