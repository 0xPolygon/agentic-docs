...
description: "!!!info This series of documents describes in detail the various stages L2 transactions go through, from the time they are created in users' wallets to the time"
---
