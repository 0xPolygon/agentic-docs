---
title: "Sequencer Resistance"
description: "Users must rely on a trusted sequencer for their transactions to be executed in the L2. However, users can include their transactions in a forced batch if they "
---
