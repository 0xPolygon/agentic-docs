---
title: "Admin Role"
description: "Polygon zkEVM's _Admin_ consists of three (3) developers of the Polygon team, who oversee any upgrades of the zk-rollup software. Whenever there are bug fixes o"
---
...
An outline of the _upgrade process_ is outlined [here](upgrade-process).
...
In the event that the zkEVM contract system is in [Emergency Mode](malfunction-resistance/emergency-state), the new `getMinDelay` sets the time `minDelay` to 0. This is when the Security Council Multisig takes control.
