---
title: "L2 State Tree"
description: "This document explains how the zkEVM proving system manages changes in the L2 state tree. The main components of the zkEVM proving system are, the ROM, the prov"
---
