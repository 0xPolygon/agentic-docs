---
title: L2 state tree concept
description: This document explains how the zkEVM proving system manages changes
  in the L2 state tree. The main components of the zkEVM proving system are, the
  ROM, the prov
---
...
An example of a Merkle proof can be found in the [Concepts section](../../concepts/sparse-merkle-trees/sparse-merkle-tree).
