---
title: "Secondary Sms Lookup Tables"
description: "Let's assume that the cryptographic backend only allows defining constraints with additions and multiplications. Consider implementing an exponentiation operati"
---
