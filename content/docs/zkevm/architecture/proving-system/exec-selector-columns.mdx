---
title: "Exec Selector Columns"
description: "In the above discussions, we have generally signalled the operation applied to a specific row by writing the operation alongside that row, but outside the matri"
---
