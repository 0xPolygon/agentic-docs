...
description: In this document we discuss the differences between the Dragonfruit
  upgrade, which comes with the executor fork-ID 5, and the associated with
  fork-ID 6. The key
---
