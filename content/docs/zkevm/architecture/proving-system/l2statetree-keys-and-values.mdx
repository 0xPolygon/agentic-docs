---
title: "L2statetree Keys And Values"
description: "The Polygon zkEVM state is stored in a key-value format within a special Merkle tree known as a _Sparse Merkle Trie_ (SMT). This tree is binary and fully updata"
---
...
Readers interested in cryptographic details should refer to the [sponge construction document](../zkprover/hashing-state-machines/index) for Poseidon's basic design structure and the [Poseidon state machine document](../zkprover/hashing-state-machines/poseidon-sm) for its internal mechanism.
