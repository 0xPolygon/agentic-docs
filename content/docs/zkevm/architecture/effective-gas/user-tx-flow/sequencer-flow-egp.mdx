---
title: "Sequencer Flow Egp"
description: "In this phase of the end-to-end transaction flow, transactions go through different stages, depending on the user's $\texttt $: 1. Sequencing transactions comin"
---
