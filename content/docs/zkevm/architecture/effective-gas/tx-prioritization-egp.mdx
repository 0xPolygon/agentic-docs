---
title: "Tx Prioritization Egp"
description: "Users can sign transactions with gas prices higher than the suggested gas price for prioritized sequencing. That is, $$ \texttt > \texttt $$ The priority ratio "
---
