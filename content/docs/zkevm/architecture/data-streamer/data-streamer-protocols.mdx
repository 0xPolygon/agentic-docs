...
description: "This document explains the two data streamer protocols;
  server-source protocol, and client-server protocol. ### Server-source protocol
  The stream source and str"
---
