---
title: "How Rollbacks Work"
description: "Recall that the server-source protocol begins with calling the $\texttt (\ )$, corresponding to which a message is sent to the stream server, preparing to recei"
---
