---
title: "Bookmarks"
description: "This document describes what bookmarks are, and how they are used in client-server protocol. A stream is a sequence of entries, where these entries belong to so"
---
