---
title: "Circom Intro Brief"
description: "!!!info In this document, we describe the CIRCOM component of the zkProver. It is one of the four main components of the zkProver, as outlined . These principal"
---

!!!info
    In this document, we describe the CIRCOM component of the zkProver. It is one of the four main components of the zkProver, as outlined [here](../architecture/zkprover/index). These principal components are; the Executor or Main SM, STARK Recursion, CIRCOM, and Rapid SNARK.
...
As seen in the [zkProver overview](../architecture/zkprover/index) document, the output of the STARK recursion component is a STARK proof.
