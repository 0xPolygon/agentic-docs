---
title: "Json Rpc"
description: "Endpoint details are listed in the doc below. ## Terminal Use the Cardona testnet https://rpc.cardona.zkevm-rpc.com to test the in a terminal. For example: ### "
---
