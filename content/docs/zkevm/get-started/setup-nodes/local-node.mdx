---
title: "Local Node"
description: "This quick start guide shows you how to deploy a zkEVM rollup stack on your local machine. It sets up and runs the following components: - Prover: - zkEVM node "
---
...
<Callout type="tip" title="MacOS workaround">
