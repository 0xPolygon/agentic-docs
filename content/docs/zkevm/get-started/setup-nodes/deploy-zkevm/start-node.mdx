---
title: "Start Node"
description: "## Start node From the root directory, run the following: This command spins up the following services: - RPC node - Synchronizer - State DB - Pool DB - Mock pr"
---
...
<Callout type="info" title="Logs sample">
...
If you have errors related to configuration issues, see the warning at step 4 in the [configure node deployment](configure-node-deployment#set-up) section.
