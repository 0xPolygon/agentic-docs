...
description: "## Set up wallet contracts Clone the wallet contracts from the and install the libraries. ## Create wallets 1. Create a file. 2. Copy/paste the JavaScript code "
---
