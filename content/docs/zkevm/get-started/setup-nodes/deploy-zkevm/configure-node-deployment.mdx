---
title: Configure node deployment
description: "## Set up 1. Create some working directories. The following
  commands take care of directory placements where non-obvious. 2. Populate the
  directories by fetchin"
---
