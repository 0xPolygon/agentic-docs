...
description: "Deploying the full zkEVM stack requires installing and deploying a number of different components. Each component runs in its own Docker container. | Component "
---
