---
title: "Prerequisites"
description: "## Hardware - A Linux-based OS (e.g., Ubuntu Server 22.04 LTS). - At least 16GB RAM with a 4-core CPU. - An AMD64 architecture system. - Running a full prover i"
---
...
<Callout type="info" title="Computing resources">
...
The commands on the [install dependencies page](install-dependencies) fulfill all software requirements.
