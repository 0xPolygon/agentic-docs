---
title: "Quick Start"
description: "!!!caution Check the list of potential risks associated with the use of Polygon zkEVM in the section. ## Connect to zkEVM mainnet or testnet Add a full network "
---
