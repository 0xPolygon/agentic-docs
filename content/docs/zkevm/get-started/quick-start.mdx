---
title: Connect to zkEVM
description: "!!!caution Check the list of potential risks associated with the
  use of Polygon zkEVM in the section. ## Connect to zkEVM mainnet or testnet
  Add a full network "
---

!!!caution
    Check the list of potential risks associated with the use of Polygon zkEVM in the [Disclosures](../get-started/risk-disclosures) section.
...
**VIDEO_UNAVAILABLE_PLACEHOLDER**: `/img/zkEVM/tutorial.mp4` (removed because it exceeds Cloudflare Workers’ 25MB upload limit).
