...
description: Here's how to verify the status of a transaction when using an RPC
  node as an intermediary step to the Polygon zkEVM network. This guide is for
  users who send t
---
