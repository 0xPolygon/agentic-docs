---
title: "Using Hardhat"
description: "Hardhat is one of the popular smart contract development frameworks. It is the Polygon zkEVM's preferred framework, and therefore used in the zkEVM as a default"
---
...
!!!info
    ...
    Before starting with this deployment, please ensure that your wallet is connected to the Polygon zkEVM Testnet. See the demo [here](../get-started/quick-start) for details on how to connect your wallet.
