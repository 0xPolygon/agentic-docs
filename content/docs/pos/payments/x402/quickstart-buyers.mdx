...
description: "_To implement x402 with Polygon and your applications or agents, checkout our_ _Agentic Payments documentation._"
---
...
<Callout type="info" title="x402-fetch">
