---
title: Heimdall Bor module
description: Heimdall's bor module is responsible for managing span intervals
  and coordinating interactions with the Bor chain. Specifically, it determines
  when a new span c
---
