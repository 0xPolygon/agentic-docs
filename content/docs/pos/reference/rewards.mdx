---
title: Rewards and staking incentives
description: On the Polygon PoS network, validators stake their POL tokens as
  collateral to help secure the network. In return for their service, they earn
  rewards.
---
...
To be a validator, you need to [run a full validator node](../get-started/becoming-a-validator) and stake POL.

Also, check the [validator responsibilities](../get-started/becoming-a-validator#validator-responsibilities) page.

To be a delegator, you need to [delegate POL to a validator](../how-to/delegate).
