...
description: This guide provides a detailed list of default ports used across
  Bor and Heimdall nodes. Understanding these ports is crucial for network
  configuration and effe
---
