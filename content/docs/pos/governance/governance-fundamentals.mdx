...
description: "The Polygon PoS chain is a decentralized network of validator nodes that participate in block generation and consensus, and non-validator nodes that perform fun"
---
...
<Callout type="info" title="Hard forks vs. soft forks">
