...
description: This is a step-by-step guide to help you become a delegator in the
  Polygon network.
---
...
<Callout type="info" title="Staking MATIC">
...
## Access the dashboard
  ...
  1. In your wallet (e.g. MetaMask), choose the Ethereum mainnet.
    <center>
    <img src="/img/pos/choose-eth-mainnet.png" alt="Figure: Choose ERTHh mainnet " maxWidth="50%" />
    </center>
...
## Withdraw rewards
  ...
  1. Select **My Account**.
    <center>
    <img src="/img/pos/click-my-account.png" alt="img" maxWidth="70%" />
    </center>
...
<img src="/img/pos/unbond.png" alt="img" maxWidth="50%" />
...
Moving stake from one node to another node is a single transaction. There are no delays or unbonding periods during this event.
  ...
  4. Provide the stake amount and select **Move Stake**.
    <center>
    <img src="/img/pos/move2.png" alt="img" maxWidth="50%" />
    </center>
...
<Callout type="warning" title="Video currently unavailable">

**VIDEO_UNAVAILABLE_PLACEHOLDER**: `/img/pos/staking.mp4` (removed because it exceeds Cloudflare Workers’ 25MB upload limit).
...
#### Step 1
  ...
  <center>
  <img src="/img/pos/restake-rewards1.png" alt="img" maxWidth="50%" />
  </center>

#### Step 2

  <center>
  <img src="/img/pos/restake-rewards2.png" alt="img" maxWidth="50%" />
  </center>
...
#### Step 1
<center>
  <img src="/img/pos/withdraw1.png" alt="img" maxWidth="50%" />
</center>

#### Step 2
<center>
  <img src="/img/pos/withdraw2.png" alt="img" maxWidth="50%" />
</center>
...
#### Step 1
<center>
  <img src="/img/pos/claim-stake1.png" alt="img" maxWidth="50%" />
</center>
...
#### Step 3
<center>
  <img src="/img/pos/claim-stake3.png" alt="img" maxWidth="50%" />
</center>
...
We have recently upgraded the wallet support to WalletConnect v2.0. Now you can choose from a plethora of wallets, including Metamask, Coinbase, and others, on both desktop and mobile devices to log in.
  ...
  <center>
  <img src="/img/pos/supported-wallet.png" alt="Figure: Supported wallet" maxWidth="50%" />
  </center>
...
<img src="/img/pos/unbond.png" alt="Figure: Unbound " maxWidth="50%" />
