...
description: "### 1. Are the private keys same for Heimdall and Bor keystore?"
---
...
Refer to the [list of common commands](../../reference/commands) that might come in handy while troubleshooting.
