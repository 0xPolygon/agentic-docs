---
title: "Known Issues"
description: "This resource is designed to help you efficiently diagnose and resolve common issues encountered while interacting with the Polygon PoS network as a validator."
---
...
The recommended approach is to clear the historical data from both Heimdall and Bor, then [resync using a snapshot](../snapshots).
...
- Verify that your Heimdall node is configured with the latest seeds as listed in the [node setup documentation](../full-node/full-node-binaries#configure-heimdall-seeds-mainnet).
