---
title: "Validator Binaries"
description: "This guide will walk you through running a Polygon validator node using binaries."
---
...
<Callout type="info" title="Sync node using snapshots">
...
<Callout type="info" title="Common error">
...
<Callout type="info" title="Set file permissions">
