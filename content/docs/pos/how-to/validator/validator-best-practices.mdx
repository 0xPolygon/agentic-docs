...
description: This document explores best practices for running a Polygon PoS validator node.
---

This document explores best practices for running a Polygon PoS validator node.

<Callout type="info" title="Deploying a validator node">

Get started with the process of deploying a validator node by reading the doc on [node deployment prerequisites](../prerequisites).
...
<Callout type="warn" title="Docker and UFW">
...
<Callout type="warn" title="Public ports">
