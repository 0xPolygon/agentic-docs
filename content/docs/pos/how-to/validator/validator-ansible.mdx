---
title: Using Ansible
description: This section guides you through starting and running the validator
  node through an Ansible playbook. Check out the Git repository for details.
---
