---
title: "Validator Ansible"
description: "This section guides you through starting and running the validator node through an Ansible playbook. Check out the Git repository for details."
---
...
<Callout type="info" title="Limited spots for new validators">
...
<Callout type="idea" title="How to start over">
...
<Callout type="info" title="Sentry node with a VPN enabled">
...
<Callout type="info" title="Syncing node using snapshots">
...
<Callout type="info" title="Common errors">
...
<Callout type="info" title="RPC endpoint">
