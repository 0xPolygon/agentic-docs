---
title: Ethereum to PoS
description: This doc is currently undergoing revision, and the instructions
  provided may not be up to date. Stay tuned for updates!
---
...
<Callout type="idea" title="Custom tokens">

Looking to bridge your custom token to Polygon PoS using the official bridge? Check out the guide on [how to submit a request to get your token mapped](../ethereum-polygon/submit-mapping-request).
