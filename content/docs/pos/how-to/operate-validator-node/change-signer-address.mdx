---
title: Change owner and signer address
description: This guide will walk you through the process of changing the owner
  and signer address for your validator node.
---
...
2. Click on the **Connect to Web3** button and login using the owner address of your validator node. 
      ...
      <center>
      <img src="/img/pos/change-owner-1.png" alt="change-owner-1" maxWidth="30%" />
      </center>
