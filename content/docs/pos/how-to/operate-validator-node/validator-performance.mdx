---
title: Validator performance requirements
description: This is a guide to help users understand the validator performance
  parameters the community agreed to in PIP-4.
---
...
<Callout type="idea" title="Health status">
