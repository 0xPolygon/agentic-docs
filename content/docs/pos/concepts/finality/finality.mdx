---
title: "Finality"
description: "NOTE: With the upgrade to Heimdall v2, deterministic finality on PoS is now achieved in between 2-5 seconds thanks to the 1-2 seconds block time in Heimdall, me"
---
<Callout type="info" title="5 Second Finality in Polygon">
