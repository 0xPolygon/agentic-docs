---
title: "POL"
description: "POL is the native token upgrade for the Polygon ecosystem, designed for use in a wide range of activities and various purposes. For instance, POL is used as a t"
---
...
<Callout type="info" title="Initial amount of POL tokens">
...
Please refer to the [MATIC to POL migration guide](/pos/concepts/tokens/matic-to-pol) for details on what action you need to take, if any, depending on the chain they are currently located, i.e., Ethereum, Polygon PoS, Polygon zkEVM, etc. 

<Callout type="idea" title="Deep dive into POL">
