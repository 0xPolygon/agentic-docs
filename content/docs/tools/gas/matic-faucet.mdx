---
title: Test token faucets
description: Tokens on testnets such as PoS Amoy, Ethereum Sepolia, and zkEVM
  Cardona hold no real value and are solely used for testing purposes.
---

<Callout type="info" title="Testnet tokens hold no real-world value">
...
<Callout type="info" title="Polygon Faucet is deprecated, please use other third party faucets listed below">
...
<Callout type="idea" title="Get 0.5 Amoy POL">
...
- Head over to the [QuickNode Polygon Faucet](https://faucet.quicknode.com/polygon). Connect your Coinbase, MetaMask, or Phantom wallet by clicking on **Connect Wallet**. Then, choose **Amoy**, and finally select **Continue**.
   ...
   <center>
   <img src="/img/tools/gas/quicknode-faucet2.png" alt="img" maxWidth="80%" />
   </center>

<Callout type="idea" title="Get 2x POL">
...
<Callout type="idea" title="Get additional tokens">
