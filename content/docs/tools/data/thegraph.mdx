...
---
<Callout type="info" title="Content disclaimer">
...
![Create a Subgraph](/img/tools/thegraph/create-subgraph.png)


You will then land on your subgraph’s page. All the CLI commands you need will be visible on the right side of the page:

![CLI commands](/img/tools/thegraph/cli-commands.png)
...
![cli sample](/img/tools/thegraph/cli-sample.png)
...
![Playground](/img/tools/thegraph/playground.png)
...
![publish button](/img/tools/thegraph/publish-button.png)
...
![Publish screen](/img/tools/thegraph/publish-screen.png)
...
![Query URL](/img/tools/thegraph/query-url.png)
...
![API keys](/img/tools/thegraph/api-keys.png)
