...
3. [Configure Polygon on MetaMask](../../wallets/metamask/add-polygon-network).
...
2. Connect your MetaMask wallet to the web interface and switch to the [Amoy testnet](../../wallets/metamask/add-polygon-network).
