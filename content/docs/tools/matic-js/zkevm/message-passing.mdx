...
description: "This document demonstrates inter-layer message passing using the messaging layer of the Polygon bridge. As an example, we go over how to customize wrapped token"
---
...
- Create an instance of the zkEVM client, passing the necessary parameters. Refer [here](./initialize) for more info.
