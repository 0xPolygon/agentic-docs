---
title: "Get Started"
description: "Matic.js a JavaScript library that facilitates interaction with the Polygon network. It provides developers with simplified operations such as depositing, trans"
---
...
- Click for more details on POS applications that use [`web3js`](setup/web3js).
- Click for more details on POS applications that use [`ethers`](setup/ethers).
