---
title: "Withdraw Exit Many"
description: "The withdrawExitMany method can be used to exit the withdraw process by using the txHash from withdrawStartMany method."
---
