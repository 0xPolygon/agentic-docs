---
title: "Abi Manager"
description: "matic.js internally uses ABIManager for handling ABI management, configuration for you. All of the ABI and config are taken from static repo."
---
