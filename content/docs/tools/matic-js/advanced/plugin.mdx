---
title: "Plugin"
description: "Using plugin you can inject your code into matic.js. It can be used to write common set of generic codes which can be provided to anyone using a package."
---
