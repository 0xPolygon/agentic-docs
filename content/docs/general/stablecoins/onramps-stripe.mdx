---
title: "Stripe Onramp Tutorial"
description: "How to integrate Stripe Onramp into your application"
---

Use Stripe's Crypto Onramp API to let users buy USDC on Polygon directly inside
your app. You'll create an Onramp session on the backend and render Stripe's
...
- [Stripe API - Crypto Onramp Sessions](https://docs.stripe.com/crypto/onramp_sessions)
